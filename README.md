...
1. [Array Order Alphabetically](#array-order-alphabetically)
2. [Date](#date)
3. [Deep Clone](#deep-clone)
4. [Filter](#filter)
5. [Foreach Loop](#foreach)
6. [Group and GroupMap](#group-and-groupmap)
7. [If Validation](#if-validation)
8. [Immutable Reverse](#immutable-reverse)
9. [Immutable Sort](#immutable-sort)
